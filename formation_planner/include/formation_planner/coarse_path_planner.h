...
public:
  ...
  bool Plan(math::Pose start, math::Pose goal, std::vector<math::Pose> &result, const std::vector<std::vector<std::vector<double>>> hyperparam_set);
...
private:
  ...
  bool ExpandNextNode(const Node3d &node, int next_index, Node3d &next_node, const std::vector<std::vector<std::vector<double>>> hyperparam_set);
  ...
  bool CheckOneshotPath(const Node3d &node, const Node3d &goal, std::vector<math::Pose> &result, const std::vector<std::vector<std::vector<double>>> hyperparam_set);
