...
// class FormationPlannerROS : public nav_core::BaseLocalPlanner {
// public:

//   FormationPlannerROS();
//   FormationPlannerROS(std::string name, tf2_ros::Buffer* tf,
...
//   std::shared_ptr<formation_planner::FormationPlanner> planner_;
...
class FormationPlannerROS : public nav_core::BaseGlobalPlanner {
public:

  FormationPlannerROS();
  FormationPlannerROS(std::string name,
                      costmap_2d::Costmap2DROS* costmap_ros);
