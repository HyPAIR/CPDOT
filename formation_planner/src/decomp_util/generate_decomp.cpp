...
int main(int argc, char* argv[])
{
    ...
    std::ofstream outFileHyperplane("/home/weijian/Heterogeneous_formation/src/formation_planner/src/decomp_util/hyperplane.yaml");
    ...
    std::ofstream outFileVertice("/home/weijian/Heterogeneous_formation/src/formation_planner/src/decomp_util/vertices.yaml");
