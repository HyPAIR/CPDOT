...
void DrawTrajectoryRvizSE(const FullStates sol_traj, std::shared_ptr<formation_planner::PlannerConfig> config,
int robot_index, ros::Publisher path_pub) {
...
ros::init(argc, argv, "formation_test_node");
...
ros::NodeHandle nh;
ros::Publisher path_pub = nh.advertise<nav_msgs::Path>("/formation_test_path", 1, false);
ros::Publisher path_pub_diff1 = nh.advertise<nav_msgs::Path>("/formation_test_path_diff1", 1, false);
ros::Publisher path_pub_diff2 = nh.advertise<nav_msgs::Path>("/formation_test_path_diff2", 1, false);
ros::Publisher path_pub_diff3 = nh.advertise<nav_msgs::Path>("/formation_test_path_diff3", 1, false);
ros::Publisher path_pub_diff4 = nh.advertise<nav_msgs::Path>("/formation_test_path_diff4", 1, false);
ros::Publisher path_pub_car1 = nh.advertise<nav_msgs::Path>("/formation_test_path_car1", 1, false);
ros::Publisher path_pub_car2 = nh.advertise<nav_msgs::Path>("/formation_test_path_car2", 1, false);

interactive_markers::InteractiveMarkerServer server_("/formation_obstacle");
...
visualization::Init(nh, "map", "/formation_test_vis");
...
auto traj_1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/gazebo_demo/trl_2.yaml");
auto solution1 = traj2fullstates(traj_1);
// DrawTrajectoryRvizSE(solution1, config_, 3, path_pub_car2);

for (int i = 0; i < 4; i++) {
visualization::PlotPolygon(polys[i], 0.2, visualization::Color::Black, i, "Boundary"+ std::to_string(i));
}
for (int i = 4; i < polys.size(); i++) {
visualization::PlotPolygon(polys[i], 0.2, visualization::Color::Black, i, "Obstacle"+ std::to_string(i));
}
visualization::Trigger(); 
double coarse_path_time, solve_time_leader, solve_time_diff1, solve_time_diff2, solution_car_like;
const std::vector<formation_planner::visualization::Vector> corridor_sets;
// if (count_factor > 5)
...
// writeVectorToYAML(new_vector, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/fp_compare_2023.yaml");
...
// writeTrajectoryToYAML(solution, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/gazebo_demo/trl_3.yaml");
// writeTrajectoryToYAML(solution, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/flexible_formation/traj_leader.yaml");
// writeTrajectoryToYAML(solution_diff_drive1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/flexible_formation/traj_diff1.yaml");
// writeTrajectoryToYAML(solution_car_like1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/flexible_formation/traj_car1.yaml");
...
count_factor++; 
// writeTrajectoryToYAML(solution, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_1.yaml");
// writeTrajectoryToYAML(solution_car_like1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_2.yaml");
// writeTrajectoryToYAML(solution_car_like2, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_3.yaml");
// writeTrajectoryToYAML(solution_diff_drive1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_4.yaml");
// writeTrajectoryToYAML(solution_diff_drive2, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_5.yaml");
// writeTrajectoryToYAML(solution_diff_drive3, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_6.yaml");
// writeTrajectoryToYAML(solution_diff_drive4, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_7.yaml");
...
// config_->opti_w_diff_drive = 0.05;
// int case_index_ = 0;
// // auto traj_1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_1.yaml");
// // auto solution1 = traj2fullstates(traj_1);
// // auto traj_2 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_2.yaml");
// // auto solution2 = traj2fullstates(traj_2);
// // auto traj_3 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_3.yaml");
...
// goal.x = 0.0;
// goal.y = case_index_;
// formation_planner::FullStates traj_fol_diff1;
// if(!planner_->Plan(traj_fol_diff1, start, goal, iris_problem, traj_fol_diff1, coarse_path_time, solve_time_leader, true, corridor_sets)) {
// solve_fail = true;
// continue;
// } 
...
// // DrawTrajectoryRviz(solution_diff_drive3, config_, 5, path_pub_diff3);
// // DrawTrajectoryRviz(solution_diff_drive4, config_, 6, path_pub_diff4);
// // writeTrajectoryToYAML(solution, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_1.yaml");
// // writeTrajectoryToYAML(solution_car, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_2.yaml");
// // writeTrajectoryToYAML(solution_diff_drive1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/rviz_3.yaml");
// count_factor++; 
// // writeTrajectoryToYAML(solution, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_1.yaml");
// // writeTrajectoryToYAML(solution_car_like1, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_2.yaml");
// // writeTrajectoryToYAML(solution_car_like2, "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/irregular_formation/result/trl_3.yaml");
