...
ros::Publisher path_pub_diff3 = nh.advertise<nav_msgs::Path>("/liom_test_path_diff3", 1, false);
ros::Publisher path_pub_diff4 = nh.advertise<nav_msgs::Path>("/liom_test_path_diff4", 1, false);
