    ...
    <model name="cylinder_)"+ std::to_string(id) +R"(">
      ...
      <link name="link">
        ...
        <visual name="visual">
          ...
          <material>
            <ambient>0.65 0.16 0.16 1</ambient> 
            <diffuse>0.65 0.16 0.16 1</diffuse> 
          </material>
        </visual>
        <collision name="collision">
          <geometry>
...
int main() {
    ...
    std::ofstream file("/home/weijian/CPDOT/src/formation_planner/gazebo/worlds/icra_world.world");
    ...
    file << R"(
      <plugin name="dynamic_lines_mover" filename="/home/weijian/CPDOT/devel/lib/libdynamic_lines_mover.so"/>
    </model>)";
    double obs_x = 0.8;
    double obs_y = 0.4;
    ...
    auto height_set = readVectorsFromYAML("/home/weijian/CPDOT/src/formation_planner/traj_result/obs_height_" + std::to_string(num_obs) + ".yaml");
    // write obstacles
