...
class CpdotIPOPTInterfaceFm : public Ipopt::TNLP
{
public:
  CpdotIPOPTInterfaceFm(double w_inf, const std::vector<Constraints> &profile, const std::vector<FullStates> &guess, const PlannerConfig &config, const std::vector<double>& height_cons)
  ...
  virtual ~CpdotIPOPTInterfaceFm() = default;

  CpdotIPOPTInterfaceFm(const CpdotIPOPTInterfaceFm&) = delete;
  CpdotIPOPTInterfaceFm& operator=(const CpdotIPOPTInterfaceFm&) = delete;
...
class CpdotIPOPTInterface : public Ipopt::TNLP
{
public:
  CpdotIPOPTInterface(double w_inf, const Constraints &profile, const FullStates &guess, const PlannerConfig &config)
  ...
  virtual ~CpdotIPOPTInterface() = default;

  CpdotIPOPTInterface(const CpdotIPOPTInterface&) = delete;
  CpdotIPOPTInterface& operator=(const CpdotIPOPTInterface&) = delete;
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
class CpdotIPOPTInterface_diff_drive : public Ipopt::TNLP
{
public:
  CpdotIPOPTInterface_diff_drive(double w_inf, const Constraints &profile, const FullStates &guess, const FullStates &pre_sol, const PlannerConfig &config)
  ...
  virtual ~CpdotIPOPTInterface_diff_drive() = default;

  CpdotIPOPTInterface_diff_drive(const CpdotIPOPTInterface_diff_drive&) = delete;
  CpdotIPOPTInterface_diff_drive& operator=(const CpdotIPOPTInterface_diff_drive&) = delete;
...
class CpdotIPOPTInterface_car_like_replan : public Ipopt::TNLP
{
public:
  CpdotIPOPTInterface_car_like_replan(double w_inf, const Constraints &profile, const FullStates &guess, const FullStates &pre_sol, const PlannerConfig &config)
    : w_inf_(w_inf), profile_(profile), guess_(guess), pre_sol_(pre_sol), config_(config) {
    nfe_ = guess_.states.size();
    nrows_ = nfe_ - 2;
    // disc_nvar_ = config_.vehicle.n_disc * 2;
  ...
  virtual ~CpdotIPOPTInterface_car_like_replan() = default;

  CpdotIPOPTInterface_car_like_replan(const CpdotIPOPTInterface_car_like_replan&) = delete;
  CpdotIPOPTInterface_car_like_replan& operator=(const CpdotIPOPTInterface_car_like_replan&) = delete;
...
bool LightweightProblem::Solve(
  ...
  Ipopt::SmartPtr<CpdotIPOPTInterface> interface = new CpdotIPOPTInterface(w_inf, profile, guess, *config_);
...
bool LightweightProblem::Solve_diff_drive(
  ...
  Ipopt::SmartPtr<CpdotIPOPTInterface_diff_drive> interface = new CpdotIPOPTInterface_diff_drive(w_inf, profile, guess, pre_sol, *config_);
...
bool LightweightProblem::Solve_replan(
  ...
  Ipopt::SmartPtr<CpdotIPOPTInterface_car_like_replan> interface = new CpdotIPOPTInterface_car_like_replan(w_inf, profile, guess, pre_sol, *config_);
...
bool LightweightProblem::SolveFm(
  ...
  Ipopt::SmartPtr<CpdotIPOPTInterfaceFm> interface = new CpdotIPOPTInterfaceFm(w_inf, profile, guess, *config_, height_cons);
