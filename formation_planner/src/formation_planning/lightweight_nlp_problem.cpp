...
{
public:
  LiomIPOPTInterfaceFm(double w_inf, 
                       ...
                       const std::vector<double>& height_cons)
...
bool LightweightProblem::SolveFm(
  ...
  Ipopt::SmartPtr<LiomIPOPTInterfaceFm> interface = new LiomIPOPTInterfaceFm(w_inf, hPolys_sets, profile, guess, *config_, height_cons);
