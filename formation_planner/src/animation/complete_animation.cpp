...
void PlotPoseFG(std::shared_ptr<formation_planner::PlannerConfig> config, int robot_index, int time_step, vector<vector<vector<double>>> plan, vector<double> robot_type) {
    const std::string robot_name = "Footprint_" + std::to_string(robot_index);
    // visualization::Delete(i, robot_name);
    // visualization::Trigger();
...
void PlotTrajectoryFG(std::shared_ptr<formation_planner::PlannerConfig> config, const std::vector<std::vector<std::vector<double>>>& traj_set) {
...
void PlotPose(std::shared_ptr<formation_planner::PlannerConfig> config, int robot_index, int time_step, Trajectory_temp traj, std::vector<double> robot_type) {
...
int main(int argc, char* argv[])
{
    ...
    std::string file_front = "/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/complete_demo_2/result/";
    std::string file_back = ".yaml";
    // auto traj_1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/replan.yaml");
	// auto traj_fol1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/replan_car.yaml");
	// auto traj_fol_diff_r = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/replan_diff.yaml");
    // auto traj_1_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/leader_h.yaml");
	// auto traj_fol1_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/solution_car_like_h.yaml");
	// auto traj_fol_diff_r_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_oppositing/solution_diff_drive_h.yaml");
    // auto traj_1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/replan.yaml");
	// auto traj_fol1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/replan_car.yaml");
	// auto traj_fol_diff_r = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/replan_diff.yaml");
    // auto traj_1_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/leader_h.yaml");
	// auto traj_fol1_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/solution_car_like_h.yaml");
	// auto traj_fol_diff_r_h = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/two_robots_following/solution_diff_drive_h.yaml");
    ...
    auto plan =  generate_traj_fg("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/ras_demo/formation_generation/fg_16.yaml", 16);
    ...
    visualization::Init(nh, "odom", "/formation_test_vis");
    ...
    ros::Publisher path_pub_car3 = nh.advertise<nav_msgs::Path>("/formation_test_path_car3", 1, false);
    ros::Publisher path_pub_car4 = nh.advertise<nav_msgs::Path>("/formation_test_path_car4", 1, false);
    ros::Publisher path_pub_car5 = nh.advertise<nav_msgs::Path>("/formation_test_path_car5", 1, false);
