...
int main(int argc, char **argv)
{
	...
	ros::Duration dt;
	int robot_index = 1;
	auto plan =  generate_traj_fg("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/ras_demo/formation_generation/fg_gazebo.yaml", 10);
	// int robot_index = 0;
	// auto traj_1 = generate_traj("/home/weijian/Heterogeneous_formation/src/formation_planner/traj_result/ras_demo/result/diff_drive0.yaml");
