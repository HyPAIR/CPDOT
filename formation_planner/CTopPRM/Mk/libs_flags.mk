...
# 添加yaml-cpp库的编译和链接选项
YAML_CPP_CFLAGS=$(shell pkg-config --cflags yaml-cpp)
YAML_CPP_LDFLAGS=$(shell pkg-config --libs yaml-cpp)

CPPFLAGS+=-I./include $(LOG4CXX_CPPFLAGS) $(RRT_CFLAGS) $(CNPY_CFFLAGS) $(YAML_CPP_CFLAGS)
LDFLAGS+=$(LOG4CXX_LDFLAGS) $(RRT_LDFLAGS) $(CNPY_LDFLAGS) $(YAML_CPP_LDFLAGS) -lyaml-cpp
